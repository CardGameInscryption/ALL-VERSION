...
namespace ALPHA_0._4._8._2
{
    internal class Program
    {
        // бои 
        static void gornostai_pozition_damage1()
        {
            while (true)
            {
        ...
        static void gornostai_pozition_damage3()
        {
            while (true)
            {
                Console.WriteLine("Что бы начать или завершить атаку нажми на Tab");
        ...
        static void gornostai_pozition_damage4()
        {
            while (true)
            {
                Console.WriteLine("Что бы начать или завершить атаку нажми на Tab");
           ...
           \__/   \__/
            ...
            while (true)
            {
                ...
                if (mesto_gornostai == 1)
                {
                    ...
                    void boi1()
                    {
                        gornostai_pozition_damage1();
                    }
                    boi1();

                    break;
                }
                else if (mesto_gornostai == 2)
                {
                    Console.Clear();
                    break;
                }
